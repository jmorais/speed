...
- `DOWNLOAD_CHUNKS`: number of chunks streamed to the browser, default `256`
- `UPLOAD_PAYLOAD_BYTES`: bytes sent per upload pass, default `4194304`
- `UPLOAD_PASSES`: number of upload passes, default `3`
- `UPLOAD_LIMIT_MB`: maximum accepted upload size in MB, default `128`
